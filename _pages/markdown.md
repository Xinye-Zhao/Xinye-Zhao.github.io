...
* Go to the [commit list](https://github.com/Xinye-Zhao/Xinye-Zhao.github.io/commits/master) (on your repo) to find the last version GitHub built with Jekyll. 
...
* Your CV can be written using either Markdown ([preview](https://Xinye-Zhao.github.io/cv/)) or generated via JSON ([preview](https://Xinye-Zhao.github.io/cv-json/)) and the layouts are slightly different. You can update the path to the one being used in `_data/navigation.yml` with the JSON formatted CV being hidden by default.

 * The [Liquid syntax guide](https://shopify.github.io/liquid/tags/control-flow/) is a useful guide for those that want to add functionality to the template or to become contributors to the [template on GitHub](https://github.com/Xinye-Zhao/Xinye-Zhao.github.io).
